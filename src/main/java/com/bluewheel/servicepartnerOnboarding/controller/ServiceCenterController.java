...
public class ServiceCenterController {
	...
	public ResponseEntity<String> createBusinessRule(@RequestBody @Valid ServiceCenterVO serviceCenter) {
		log.info("Request received to add a service center");
		String basevo = serviceCenterService.onBoardServiceCenter(serviceCenter);
		log.info(basevo);
	...
	public ResponseEntity<String> addVerificationDetails(@RequestBody @Valid VerificationVO verificationvo) {
		log.info("Request received to add a service center");
		String basevo = serviceCenterService.addVerificationDetails(verificationvo);
		log.info(basevo);
		return ResponseEntity.ok().body(basevo);
	...
	public ResponseEntity<String> addFlexInstallationDetails(@RequestBody @Valid CommonVO flexvo) {
		log.info("Request received to add a service center");
		String basevo = serviceCenterService.addFlexInstallationDetails(flexvo);
		log.info(basevo);
		return ResponseEntity.ok().body(basevo);
	...
	public ResponseEntity<String> addPhotographyDetails(@RequestBody @Valid CommonVO phVO) {
		log.info("Request received to add a service center");
		String basevo = serviceCenterService.addPhotographyDetails(phVO);
		log.info(basevo);
		return ResponseEntity.ok().body(basevo);
	...
	public ResponseEntity<String> addTrainingDetails(@RequestBody @Valid CommonVO phVO) {
		log.info("Request received to add a service center");
		String basevo = serviceCenterService.addTrainingDetails(phVO);
		log.info(basevo);
		return ResponseEntity.ok().body(basevo);
	...
	public ResponseEntity<String> addOnboardingetails(@RequestBody @Valid CommonVO phVO) {
		log.info("Request received to add a service center");
		String basevo = serviceCenterService.addOnboardDetails(phVO);
		log.info(basevo);
		return ResponseEntity.ok().body(basevo);
